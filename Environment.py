...
class Environment(tk.Tk, object):
    ...
    def build_4x4_environment(self):
        ...
        # Final Point
        img_flag = Image.open("images/target.png")
    ...
    def build_10x10_environment(self):
        ...
        # Creating obstacles themselves
        self.obstacle1 = self.canvas_widget.create_image(pixels * 0, pixels * 9, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle2 = self.canvas_widget.create_image(pixels * 2, pixels * 2, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle3 = self.canvas_widget.create_image(pixels * 1, pixels * 6, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle4 = self.canvas_widget.create_image(pixels * 2, pixels * 3, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle5 = self.canvas_widget.create_image(pixels * 2, pixels * 4, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle6 = self.canvas_widget.create_image(pixels * 2, pixels * 7, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle7 = self.canvas_widget.create_image(pixels * 3, pixels * 3, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle8 = self.canvas_widget.create_image(pixels * 3, pixels * 4, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle9 = self.canvas_widget.create_image(pixels * 4, pixels * 3, anchor='nw',
                                                         image=self.obstacle1_object)
        self.obstacle10 = self.canvas_widget.create_image(pixels * 4, pixels * 5, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle11 = self.canvas_widget.create_image(pixels * 4, pixels * 4, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle12 = self.canvas_widget.create_image(pixels * 5, pixels * 3, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle13 = self.canvas_widget.create_image(pixels * 6, pixels * 3, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle14 = self.canvas_widget.create_image(pixels * 6, pixels * 4, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle15 = self.canvas_widget.create_image(pixels * 6, pixels * 7, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle16 = self.canvas_widget.create_image(pixels * 6, pixels * 8, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle17 = self.canvas_widget.create_image(pixels * 6, pixels * 9, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle18 = self.canvas_widget.create_image(pixels * 5, pixels * 4, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle19 = self.canvas_widget.create_image(pixels * 3, pixels * 7, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle20 = self.canvas_widget.create_image(pixels * 8, pixels * 1, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle21 = self.canvas_widget.create_image(pixels * 8, pixels * 6, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle22 = self.canvas_widget.create_image(pixels * 8, pixels * 6, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle23 = self.canvas_widget.create_image(pixels * 9, pixels * 2, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle24 = self.canvas_widget.create_image(pixels * 9, pixels * 5, anchor='nw',
                                                          image=self.obstacle1_object)
        self.obstacle25 = self.canvas_widget.create_image(pixels * 9, pixels * 7, anchor='nw',
                                                          image=self.obstacle1_object)
